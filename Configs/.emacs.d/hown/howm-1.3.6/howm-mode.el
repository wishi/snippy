...
;;; $Id: howm-mode.el,v 1.290.2.1 2007-11-08 14:51:29 hira Exp $
;;;
...
(defvar howm-migemo-client-option nil
  "List of option for migemo-client.
e.g. (\"-H\" \"::1\")")

;; (defvar howm-migemo-client nil
;;   "Command name (string) of migemo-client. Nil means default command.
;; Example:
;;   (setq howm-migemo-client \"my-migemo-client-command\")
;;   (setq howm-migemo-client '(\"migemo-client\" \"-H\" \"::1\")) ;; options
;;   (setq howm-migemo-client '(nil \"-H\" \"::1\")) ;; same as the above")
