    ...
    class Handler extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                String line="pre"; //  = in.readObject().toString(); // inited
                String ack="Ok";
                
                while (!(line = in.readObject().toString()).equals("quit")) {
                    ...
                    // System.out.println("IP: " + socket.getRemoteSocketAddress() + "Port" + socket.getPort());
